...
@section('content')
<div>
    <h1 class="text-3xl font-bold mb-6">Create New Portfolio Project</h1>
    
    <form method="POST" action="{{ route('admin.portfolios.store') }}" class="bg-white p-6 rounded-lg shadow">
        @csrf
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="service_slug" value="{{ old('service_slug') }}" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="e.g., website-development">
                </div>
            </div>
