...
<div>
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold">Portfolio Projects</h1>
        <a href="{{ route('admin.portfolios.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($portfolios as $portfolio)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">{{ $portfolio->category }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $portfolio->slug }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-4 text-center text-gray-500">No portfolios found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
