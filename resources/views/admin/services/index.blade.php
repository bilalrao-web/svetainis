...
<div>
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.services.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">
                ...
                @forelse($services as $service)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 py-1 text-xs rounded {{ $service->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
