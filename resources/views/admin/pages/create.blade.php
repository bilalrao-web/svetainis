...
<div>
    ...
    <form method="POST" action="{{ route('admin.pages.store') }}" class="bg-white p-6 rounded-lg shadow">
        @csrf
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="content" rows="10" 
                    class="w-full px-3 py-2 border border-gray-300 rounded-md">{{ old('content') }}</textarea>
            </div>
