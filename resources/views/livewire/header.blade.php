<header class="header">
    ...
    <nav class="main-nav">
        <ul>
            ...
            <li><a href="{{ route('services') }}" class="{{ request()->routeIs('services') || request()->routeIs('service.detail') || request()->is('services*') || request()->routeIs('portfolio.detail') ? 'active' : '' }}" wire:navigate>Services</a></li>
