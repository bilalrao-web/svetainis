<div class="themain">
    ...
    <div class="page-hero">
        <div class="page-hero-content">
            <h1 class="animate-fade-in-down">Services</h1>
            <p class="breadcrumb animate-fade-in-up">HOME > <span>SERVICES</span></p>
        </div>
    </div>
    ...
    <div class="services-page-section">
        ...
        <div class="services-grid">
            ...
            <a href="{{ route('service.detail', ['service' => 'website-development']) }}" class="service-card animate-fade-in-up" wire:navigate>
                ...
                <p>Custom websites built with modern technologies, responsive design, and optimized performance for your business needs.</p>
            </a>
            ...
            <a href="{{ route('service.detail', ['service' => 'graphic-designing']) }}" class="service-card animate-fade-in-up" style="animation-delay: 0.1s;" wire:navigate>
                ...
                <p>Creative visual solutions including logos, branding, marketing materials, and digital graphics that make your brand stand out.</p>
            </a>
            ...
            <a href="{{ route('service.detail', ['service' => 'digital-marketing']) }}" class="service-card animate-fade-in-up" style="animation-delay: 0.2s;" wire:navigate>
                ...
                <p>Strategic online marketing campaigns to boost your visibility, engage your audience, and drive conversions across all digital platforms.</p>
            </a>
            ...
            <a href="{{ route('service.detail', ['service' => 'seo-content-writing']) }}" class="service-card animate-fade-in-up" style="animation-delay: 0.3s;" wire:navigate>
                ...
                <p>High-quality content creation and SEO optimization to improve your search rankings and attract more organic traffic to your website.</p>
            </a>
            ...
            <a href="{{ route('service.detail', ['service' => 'app-development']) }}" class="service-card animate-fade-in-up" style="animation-delay: 0.4s;" wire:navigate>
                ...
                <p>Native and cross-platform mobile applications for iOS and Android, designed to deliver exceptional user experiences and business value.</p>
            </a>
            ...
            <a href="{{ route('service.detail', ['service' => 'ui-ux-designing']) }}" class="service-card animate-fade-in-up" style="animation-delay: 0.5s;" wire:navigate>
                ...
                <p>User-centered design solutions that create intuitive, engaging, and accessible interfaces for web and mobile applications.</p>
            </a>
        </div>
    </div>
    ...
    <div class="cta-section">
        <h2>We're Ready to Bring Bigger & Stronger Projects</h2>
        <a href="{{ route('contact') }}" class="contact-button" wire:navigate>Contact with us</a>
    </div>
</div>
